...
* 
*/
class Importph extends CI_Controller
{
...
*/
    		for($i = 3; $i <= $numRows; $i++){
              ...
              $idhab = $this->get_hab->getidhabilitadora($gerencia);
                   ...
                   // echo "idhabilitadora ". $value->idhab;
                   
                    switch ($planreal) {
                        case '1':
                                if($this->get_hab->gethabplannum_rows($idhab,$dist,$anho,$auxmoneda) > 0){

                                    echo "el plan para las habilitadora ya esta debidamente cargado";

                                }else{

                                  

                                   $habilitadora = array('idhabfk' =>  $idhab,
                                                          'idelecfk' =>  $dist);     
                        ...
                        case '2':
                                if($this->get_hab->gethabrealnum_rows($idhab,$dist,$anho,$auxmoneda) > 0){
                                     ...
                                     echo "el real para las habilitadora ya esta debidamente cargado";
             ...
             ?> <script>
                ...
                window.location= '<?= base_url()?>habilitadora/cpahab';
            </script><?php
