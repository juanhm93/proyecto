<div class="Contenedor-Editable" id="Region-Editable">
 	...
 	<span class="Titulo-Aplicacion">DIVISIÓN ORIENTAL</span>
					<span class="Separador_Modulo"></span>
					<span class="Sub-Titulo-Aplicacion">Ver resumen</span>
	
		 <div class="form-group select_container">
										<div for="anhodivoriental" class="select_title">Año</div>		
										<select class="select-select" id="anhodivoriental" name="anhodivoriental" >
	...
	<div id="orientaltabla" style="overflow-y: auto; height: 500px;background:#C1C0B2;"  class='Tabla-Aplicacion'>
		<!-- cabecera de Arriba -->
