<div class="Contenedor-Editable" id="Region-Editable">
 	...
 	<span class="Titulo-Aplicacion">Esfuerzo Propio Division Occidental</span>
		...
		<table id="resumentotal" class="display nowrap" cellspacing="0" width="100%">
			...
			<tbody>
					...
					<div id="planhab" class="tabcontent">
						...
						<div class="radio">
  									<input type="radio"  name="mostrarp" id="planbs" value="pepdivocc1">
									<label for="planbs">Plan MMBsF</label>

									<input type="radio"  name="mostrarp" id="pland" value="pepdivocc2" >
									<label for="pland">Plan MM$</label>

									<input type="radio"  name="mostrarp" id="plande" value="pepdivocc3">
					...
					<div id="realhab" class="tabcontent">
	  					<div class="radio">
	  					 	<input type="radio"  name="mostrarp" id="realbs" value="repdivocc1">
									<label for="realbs">Real MMBsF</label>

									<input type="radio"  name="mostrarp" id="reald" value="repdivocc2">
									<label for="reald">Real MM$</label>

									<input type="radio"  name="mostrarp" id="realde" value="repdivocc3">
					...
					<div id="mvhab" class="tabcontent">
							<div class="radio">
  									<input type="radio"  name="mostrarp" id="mvbs" value="mvepdivocc1">
									<label for="mvbs">Mejor Vision MMBsF</label>
									<input type="radio"  name="mostrarp" id="mvd" value="mvepdivocc2">
									<label for="mvd">Mejor Vision MM$</label>
									<input type="radio"  name="mostrarp" id="mvde" value="mvepdivocc3">
					...
					<div id="anthab" class="tabcontent">
							<div class="radio">
  									<input type="radio"  name="mostrarp" id="antbs" value="antepdivocc1">
									<label for="antbs">anteproyecto MMBsF</label>
									<input type="radio"  name="mostrarp" id="antd" value="antepdivocc2">
									<label for="antd">anteproyecto MM$</label>
									<input type="radio"  name="mostrarp" id="antde" value="antepdivocc3">
